...
$acao = $isEdit ? "index.php?route=cadastros&type=usuarios&action=update&id={$registro['id']}" : "index.php?route=cadastros&type=usuarios&action=store";
?>
...
<div class="top-bar">
    ...
    <a href="index.php?route=cadastros&type=usuarios" class="btn btn-secondary" title="Voltar para a lista" style="--btn-index: 1;">
...
<div class="card shadow mb-4">
    <div class="card-header">
        <h6 class="m-0 font-weight-bold">Formulário de Usuário</h6>
    </div>
    <div class="card-body">
        ...
        <form action="<?php echo $acao; ?>" method="post">
            ...
            <div class="form-section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3" style="animation: fadeIn 0.6s ease-out forwards; animation-delay: 0.2s;">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="<?php echo $isEdit ? htmlspecialchars($registro['email']) : ''; ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3" style="animation: fadeIn 0.6s ease-out forwards; animation-delay: 0.5s;">
                        <label for="nivel_acesso" class="form-label required">Nível de Acesso</label>
                        <select class="form-select" id="nivel_acesso" name="nivel_acesso" required>
                            <option value="">Selecione um nível</option>
                            <option value="admin" <?php echo $isEdit && $registro['nivel_acesso'] == 'admin' ? 'selected' : ''; ?>>Administrador</option>
                            <option value="gerente" <?php echo $isEdit && $registro['nivel_acesso'] == 'gerente' ? 'selected' : ''; ?>>Gerente</option>
                            <option value="usuario" <?php echo $isEdit && $registro['nivel_acesso'] == 'usuario' ? 'selected' : ''; ?>>Usuário Padrão</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="btn-group">
                <button type="submit" class="btn btn-primary" style="--btn-index: 1;" title="Salvar Usuário">
                    <i class="fas fa-save"></i> Salvar
                </button>
                <a href="index.php?route=cadastros&type=usuarios" class="btn btn-secondary" style="--btn-index: 2;" title="Cancelar">
