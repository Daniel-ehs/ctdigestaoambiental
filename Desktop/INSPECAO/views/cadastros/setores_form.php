...
$titulo = $isEdit ? 'Editar Setor' : 'Novo Setor';
$acao = $isEdit ? "index.php?route=cadastros&type=setores&action=update&id={$registro['id']}" : "index.php?route=cadastros&type=setores&action=store";
?>
...
<div class="top-bar">
    ...
    <a href="index.php?route=cadastros&type=setores" class="btn btn-secondary" title="Voltar para a lista" style="--btn-index: 1;">
...
<div class="card shadow mb-4">
    <div class="card-header">
        <h6 class="m-0 font-weight-bold">Formulário de Setor</h6>
    </div>
    <div class="card-body">
        ...
        <form action="<?php echo $acao; ?>" method="post">
            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3" style="animation: fadeIn 0.6s ease-out forwards; animation-delay: 0.2s;">
                        <label for="descricao" class="form-label">Descrição</label>
                        <textarea class="form-control" id="descricao" name="descricao" rows="3" placeholder="Descreva o setor"><?php echo $isEdit ? htmlspecialchars($registro['descricao'] ?? '') : ''; ?></textarea>
                    </div>
            ...
            <div class="btn-group">
                <button type="submit" class="btn btn-primary" style="--btn-index: 1;" title="Salvar Setor">
                    <i class="fas fa-save"></i> Salvar
                </button>
                <a href="index.php?route=cadastros&type=setores" class="btn btn-secondary" style="--btn-index: 2;" title="Cancelar">
