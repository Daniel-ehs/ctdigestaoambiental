...
$titulo = $isEdit ? 'Editar Tipo de Apontamento' : 'Novo Tipo de Apontamento';
$acao = $isEdit ? "index.php?route=cadastros&type=tipos&action=update&id={$registro['id']}" : "index.php?route=cadastros&type=tipos&action=store";
?>
...
<!-- Barra superior -->
<div class="top-bar">
    <h1 class="h2 m-0" style="color: #333333;"><?php echo $titulo; ?></h5>
    <a href="index.php?route=cadastros&type=tipos" class="btn btn-secondary" title="Ações" style="--btn-index: 1;">
...
<div class="card shadow mb-4">
    <div class="card-header">
        <h6 class="m-0 font-weight-bold">Formulário de Tipo de Apontamento</h6>
    </div>
    <div class="card-body">
        ...
        <form action="<?php echo $acao; ?>" method="post">
            ...
            <div class="form-section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3" style="animation: fadeIn 0.6s ease-out forwards; animation-delay: 0.2s;">
                        ...
                        <input type="color" class="form-control form-control-color" id="cor" name="cor" value="<?php echo $isEdit ? htmlspecialchars($registro['cor']) : '#000000'; ?>" title="Escolha uma cor" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3" style="animation: fadeIn 0.6s ease-out forwards; animation-delay: 0.3s;">
                        ...
                        <textarea class="form-control" id="descricao" name="descricao" rows="3" placeholder="Descreva o tipo de apontamento"><?php echo $isEdit ? htmlspecialchars($registro['descricao'] ?? '') : ''; ?></textarea>
                    </div>
            ...
            <div class="btn-group">
                <button type="submit" class="btn btn-primary" style="--btn-index: 1;" title="Salvar Tipo">
                    <i class="fas fa-save"></i> Salvar
                </button>
                <a href="index.php?route=cadastros&type=tipos" class="btn btn-secondary" style="--btn-index: 2;" title="Cancelar">
