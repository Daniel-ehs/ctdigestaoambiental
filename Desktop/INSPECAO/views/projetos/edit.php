...
// Verificar se o projeto existe e se a lista de empresas foi carregada
if (!isset($projeto) || !$projeto || !isset($empresas)) {
...
<!-- CSS Padronizado (Baseado em inspecoes/edit.php) -->
<style>
...
@media (max-width: 768px) {
    ...
    */
    ...
    .card-body .btn-group .btn {
        ...
        height: 40px;
        padding: 0;
        flex-shrink: 0; /* Previne que os botões encolham se não houver espaço */

        /* 2. A "mágica" para esconder os textos ("Cancelar", "Salvar") */
        font-size: 0;
    ...
    /* SELETOR AGRUPADO PARA ÍCONES:
       Devolve o tamanho para os ícones dentro dos botões que acabamos de estilizar.
    */
    .top-bar .btn i,
    ...
    /* BÔNUS: Garante que o grupo de botões do formulário não quebre a linha em mobile,
       mantendo os botões de Cancelar e Salvar lado a lado. */
    .card-body .btn-group {
        flex-wrap: nowrap;
    }
}
...
<!-- Barra superior -->
<div class="top-bar">
    <h1 class="h2 m-0" style="color: #333333;">Editar Projeto #<?php echo htmlspecialchars($projeto['id']); ?></h1>
    <a href="index.php?route=projetos" class="btn btn-secondary" title="Voltar para a lista">
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form method="post" action="index.php?route=projetos&action=update&id=<?php echo $projeto['id']; ?>">
            <!-- Informações Gerais -->
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="empresa_id" name="empresa_id" required>
                            ...
                            <option value="<?php echo $empresa['id']; ?>" <?php echo ($empresa['id'] == $projeto['empresa_id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="fonte" name="fonte" value="<?php echo htmlspecialchars($projeto['fonte'] ?? ''); ?>" placeholder="Ex: Auditoria Interna, Reunião CIPA, etc.">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="prazo" class="form-label">Prazo</label>
                        <input type="date" class="form-control" id="prazo" name="prazo" value="<?php echo htmlspecialchars($projeto['prazo'] ?? ''); ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="textarea-container">
                            <textarea class="form-control" id="descricao" name="descricao" rows="4" placeholder="Descreva o objetivo e o escopo do projeto" required><?php echo htmlspecialchars($projeto['descricao'] ?? ''); ?></textarea>
                            <button type="button" class="ai-correct-btn" data-target="descricao" data-context="projeto" title="Corrigir texto com IA">
            ...
            <div class="form-section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="textarea-container">
                            <textarea class="form-control" id="observacao" name="observacao" rows="3" placeholder="Adicione observações adicionais"><?php echo htmlspecialchars($projeto['observacao'] ?? ''); ?></textarea>
                            <button type="button" class="ai-correct-btn" data-target="observacao" data-context="projeto" title="Corrigir texto com IA">
                                <i class="fas fa-magic"></i><i class="fas fa-spinner"></i>
                            </button>
                        </div>
                    </div>
            ...
            <div class="btn-group">
                <a href="index.php?route=projetos&action=view&id=<?php echo $projeto['id']; ?>" class="btn btn-secondary" title="Cancelar">
                    <i class="fas fa-times"></i> Cancelar
                </a>
                <button type="submit" class="btn btn-primary" title="Salvar Alterações">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll(".ai-correct-btn").forEach(button => {
        button.addEventListener("click", async function() {
            ...
            const context = this.dataset.context; // Pega o contexto do botão
            ...
            try {
                const response = await fetch("index.php?route=api&action=correctText", {
                    ...
                    // Envia o texto E o contexto para a API
                    body: `text=${encodeURIComponent(originalText)}&context=${encodeURIComponent(context)}`,
                });
